/****************************************************************************************
ECOMEN
From https://github.com/ecomens/esp32-cam_rcwl-0516-_ha-mqtt_telegram/
You can view detailed information about the project.
...
!Things to consider:
   ...
   - In Arduino IDE extra libraries installed:
    ...
    . PubSubClient
 License: License granted free of charge to anyone who obtains a copy.
  This software and related documentation files.
  The above copyright notice and this permission notice must be included in all entries.
  Copy or substantial portion of the Software.
  e-mail:moonbj90@gmail.com

Arduino source from: https://github.com/BeardedTek-com/esp32-cam-motion-detector
...
const char* mqtt_username = "MQTT USER NAME";           // MQTT Broker Predifined Username
const char* mqtt_password = "MQTT PASSWORD";           // MQTT Broker Predifined Password
